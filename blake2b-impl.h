...
#ifndef _BLAKE2B_IMPL_H
#define _BLAKE2B_IMPL_H
...
#include <string.h>
  ...
  #if defined(_MSC_VER)
    #define BLAKE2B_INLINE __inline
  #elif defined(__GNUC__)
    #define BLAKE2B_INLINE __inline__
  #else
    #define BLAKE2B_INLINE
  #endif
#else
  #define BLAKE2B_INLINE inline
#endif

static BLAKE2B_INLINE
